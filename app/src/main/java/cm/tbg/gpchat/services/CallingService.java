...
import cm.tbg.gpchat.utils.AudioHelper;
...
import cm.tbg.gpchat.utils.ProximitySensor;
import cm.tbg.gpchat.utils.RealmHelper;
import cm.tbg.gpchat.utils.RingtonePlayer;
import cm.tbg.gpchat.utils.SharedPreferencesManager;
import cm.tbg.gpchat.utils.SinchConfig;
...
public class CallingService extends Service implements VideoCallListener, ProximitySensor.Delegate, AudioManager.OnAudioFocusChangeListener {
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, final Call call) {
            ...
            fireManager.isCallCancelled(call.getRemoteUserId(), call.getCallId()).subscribe(isCancelled -> {
