...
import cm.tbg.gpchat.activities.calling.AgoraConfig
...
import cm.tbg.gpchat.activities.calling.model.*
import cm.tbg.gpchat.common.extensions.abandonAudioFocusCompat
import cm.tbg.gpchat.common.extensions.requestAudioFocusCompat
...
class CallingService : Service(), ProximitySensor.Delegate, AudioManager.OnAudioFocusChangeListener, DuringCallEventHandler {
    ...
    private fun joinChannel(channelName: String, uid: Int): Int {
        ...
        val appCertificate = "baafb1ac374a4fb9b980e06dd7a4abb0"
       ...
       // val uid = 0
        ...
        val token = rtcTokenBuilder.buildTokenWithUid(appId, appCertificate,
