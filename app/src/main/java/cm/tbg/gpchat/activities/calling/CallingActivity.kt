/*
 * Created by Boris Gautier on 14/$today.mounth/2021
 */
...
import cm.tbg.gpchat.activities.calling.event.CallingStateEvent
import cm.tbg.gpchat.activities.calling.event.CallingViewState
import cm.tbg.gpchat.activities.calling.model.CallType
import cm.tbg.gpchat.activities.calling.model.CallingState
import cm.tbg.gpchat.activities.calling.model.EngineConfig
import cm.tbg.gpchat.common.extensions.unBindServiceSafely
import cm.tbg.gpchat.extensions.finishAndRemoveTaskCompat
import cm.tbg.gpchat.model.ImageItem
...
import cm.tbg.gpchat.utils.network.FireManager.Companion.checkAndDownloadUserPhoto
import cm.tbg.gpchat.utils.network.FireManager.Companion.fetchUserByUid
...
class CallingActivity : BaseActivity(), ServiceConnection {
    ...
    private lateinit var btnRejectAnswer: FloatingActionButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnRejectAnswer.setOnClickListener { setStateEvent(CallingStateEvent.RejectIncoming) }
