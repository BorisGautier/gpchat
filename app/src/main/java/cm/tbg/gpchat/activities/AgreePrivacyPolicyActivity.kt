...
class AgreePrivacyPolicyActivity : AppCompatActivity() {
    ...
    private fun showContactsConfirmationDialog() {
        ...
        checkBox.text = getString(R.string.check_box)


        getHtml4(tv)

        dialog.setNegativeButton(getString(R.string.decline),null)

        dialog.setPositiveButton(getString(R.string.agree)) { dialog, which ->
